...
//=======
		...
		String imgPath6 = this.getClass().getResource(".").getPath() + "..//..//img//캡처333.jpg";
		lblNewLabel.setIcon(new ImageIcon(imgPath6));
		lblNewLabel.setBounds(896, 452, 255, 75);
		frame.getContentPane().add(lblNewLabel);

		JLabel label_4 = new JLabel("");
		String imgPath7 = this.getClass().getResource(".").getPath() + "..//..//img//호캉스.jpg";
		label_4.setIcon(new ImageIcon(imgPath7));
		label_4.setBounds(896, 538, 255, 75);
		frame.getContentPane().add(label_4);

		JLabel label_5 = new JLabel("");
		String imgPath8 = this.getClass().getResource(".").getPath() + "..//..//img//캡처2233232.jpg";
		...
		String imgPath9 = this.getClass().getResource(".").getPath() + "..//..//img//스페인.jpg";
		...
		String imgPath10 = this.getClass().getResource(".").getPath() + "..//..//img//대만.jpg";
		...
		String imgPath11 = this.getClass().getResource(".").getPath() + "..//..//img//다낭.jpg";
...
//         }
//      });
//      lblNewLabel.setIcon(new ImageIcon("C:\\Users\\User\\git\\gitRepository\\auctionnew\\auctionnew\\img\\캡처333.JPG"));
//      lblNewLabel.setBounds(896, 452, 255, 75);
//      frame.getContentPane().add(lblNewLabel);
//      
//      JLabel label_4 = new JLabel("");
//      label_4.setIcon(new ImageIcon("C:\\Users\\User\\git\\gitRepository\\auctionnew\\auctionnew\\img\\호캉스.JPG"));
//      label_4.setBounds(896, 538, 255, 75);
//      frame.getContentPane().add(label_4);
//      
//      JLabel label_5 = new JLabel("");
//      label_5.setIcon(new ImageIcon("C:\\Users\\User\\git\\gitRepository\\auctionnew\\auctionnew\\img\\캡처2233232.JPG"));
//      label_5.setBounds(896, 624, 255, 75);
//      frame.getContentPane().add(label_5);
//      
//      JLabel lblNewLabel_5 = new JLabel("New label");
...
//         }
//      });
//      lblNewLabel_5.setIcon(new ImageIcon("C:\\Users\\User\\git\\gitRepository\\auctionnew\\auctionnew\\img\\스페인.JPG"));
//      lblNewLabel_5.setBounds(204, 467, 190, 230);
//      frame.getContentPane().add(lblNewLabel_5);
//      
//      JLabel label_6 = new JLabel("New label");
...
//         }
//      });
//      label_6.setIcon(new ImageIcon("C:\\Users\\User\\git\\gitRepository\\auctionnew\\auctionnew\\img\\대만.JPG"));
//      label_6.setBounds(427, 467, 190, 230);
//      frame.getContentPane().add(label_6);
//      
//      JLabel label_7 = new JLabel("New label");
...
//         }
//      });
//      label_7.setIcon(new ImageIcon("C:\\Users\\User\\git\\gitRepository\\auctionnew\\auctionnew\\img\\다낭.JPG"));
//      label_7.setBounds(649, 467, 190, 230);
//      frame.getContentPane().add(label_7);
//      
//      
