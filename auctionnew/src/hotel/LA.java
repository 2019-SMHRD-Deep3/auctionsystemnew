...
public class LA {
	...
	private void initialize() {
		...
		LA1.setFont(new Font("∏º¿∫ ∞ÌµÒ Semilight", Font.BOLD, 18));
		...
		LA2.setFont(new Font("∏º¿∫ ∞ÌµÒ Semilight", Font.BOLD, 18));
		...
		LA3.setFont(new Font("∏º¿∫ ∞ÌµÒ Semilight", Font.BOLD, 18));
		...
		String imgPath5 = this.getClass().getResource(".").getPath() + "..//..//img//πË≥ .png";
